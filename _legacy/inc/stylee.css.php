...
/*********************************************************************************************************************
                            BG COLORS
*********************************************************************************************************************/
body, #hl_button                           {  background-color:<?php echo $palette['bg_drk']; ?>                                   }
#hl_button_x, #view_src, #print_btn,table  {  background-color:<?php echo $palette['bg_wht']; ?>                                              }
#section_3,#section_4,#section_5, #section_1,#section_2, #fretboard 
                                           {  background-color:<?php echo $palette['bg_1']; ?>                                              }
#_no_highlight_, #chord_grid, #tunings     {  background-color:<?php echo $palette['bg_1']; ?>                                              }
table.sortable                             {  background-color:<?php echo $palette['bg_1']; ?>                                              }
table.sortable tbody tr:nth-child(odd)     {  background-color:<?php echo $palette['bg_3']; ?>                                              }
#fretnums, #f_cyo_dark                     {  background-color:<?php echo $palette['bg_3']; ?>                                              }
#_x_                                       {  background-color:<?php echo $palette['bg_1']; ?>  accent-color:<?php echo $palette['bg_3']; ?> }
...
body, a,a:link,a:visited,a:active, #f_cyo, #f_cyo_dark 
                                           {  color:<?php echo $palette['bg_drk']; ?>                                              }                            
.finder, #red_fg                           {  color:<?php echo $palette['red']; ?>                                              }
a:hover                                    {  color:<?php echo $palette['bg_3']; ?>                                                         } 
#_no_highlight_                            {  color:<?php echo $palette['bg_2']; ?>                                                         }                    
#fretnums, #blurb                          {  color:<?php echo $palette['bg_2']; ?>                                                         }                         
#_5_                                       {  color:#BFBFBF;                                                         }
._i_                                       {  color:#ff0000;                                                         }
._ii_                                      {  color:#9900ff;                                                         }    
._mii_                                     {  color:#674ea7;                                                         }     
...
#section_3,#section_4,#section_5, #section_1,#section_2, #view_src, #print_btn, #hl_button, #hl_button_x
                                           {  <?php echo $corners_sm; ?>                                                    }
.nut                                       {  border-right:8px solid <?php echo $palette['bg_drk']; ?>                             }
.nut1                                      {  border-left:8px solid <?php echo $palette['bg_drk']; ?>                              }
table, table td                            {  border:1px solid <?php echo $palette['bg_3']; ?>    border-collapse:separate;                 }
#view_src, #print_btn                      {  border:1px solid #ff0000;                                              }
#hl_button, #hl_button_x                   {  border:1px solid <?php echo $palette['bg_drk']; ?>                                   }
/*********************************************************************************************************************
